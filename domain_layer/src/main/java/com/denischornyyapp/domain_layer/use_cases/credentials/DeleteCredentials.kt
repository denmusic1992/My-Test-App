...
All rights received.
 */
class DeleteCredentials(private val credentialsRepositoryImpl: CredentialsRepositoryImpl) {
    operator fun invoke() = credentialsRepositoryImpl.deleteCredentials()
}